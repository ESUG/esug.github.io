...
<!talk|subject=Visualizing Large Scale Project Evolution With DVision&author=Ian Abuaf Pelo, Marco Raglianti and Michele Lanza&length=30&room=Room B!>

<!talk|subject=Visualizing GitHub Repositories with Nautilus&author=Phillip Entin, Marco Raglianti and Michele Lanza&length=30&room=Room B!>

<!talk|subject=Information Retrieval and Pattern matching on model instances leveraging LLMs&author=Nicolas Hlad, Benoit Verhaeghe and Aless Hosry&length=30&room=Room B!>
...
<!talk|subject=Static Calls in a Dynamically-Typed Language: From Implementation Challenges to Opportunities&author=Faouzi Rayane Mokhefi, Stephane Ducasse, Luc Fabresse and Pablo Tesone&length=30&room=Room B!>

<!talk|subject=A Copy-and-Patch JIT for Threaded Interpreters&author=Nishil Kapadia and Dave Mason&length=30&room=Room B!>
...
<!talk|subject=Orbit: a workspace for agentic collaborative livecoding&author=Craig Latta&length=30&room=Room B!>
...
<!talk|subject=Software Sonification: Potential and Challenges&author=Carmen Armenti, Marco Raglianti and Michele Lanza&length=60&room=Room B!>
